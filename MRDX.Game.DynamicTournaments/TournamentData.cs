...
public class TournamentData
{
    ...
    public static string[] _random_name_list = ["Cimasio", "Kyrades", "Ambroros", "Teodeus", "Lazan", "Pegetus", "Perseos", "Asandrou", "Agametrios",
        ...
        "Bajor", "Beekler", "Bobbles", "Buu", "Brainstorm", "Bracer",
        "Calaphyx", "Cawcaws", "Cix", "Cerrusio", "Creator",
        "David", "Dingus", "Dakadaka", "Dill", "Doodle", "Daydream", "Dreameater",
        "Eater", "Eo", "Endofall", "Exuberance", "Etresse",
        "Fargus", "Fillero", "Ferrus", "Faunus", "Feathers",
        "Gronkula", "Gimmles", "Golox", "Gargamel", "Gutterman",
        "Hardness", "Herman", "Hillox", "Hundredyear", "Hurlante",
        "Io", "Iodine", "Iaz", "Illomens", "Incarnate", "Isaias",
        "Jax", "Jack", "Jillian", "Jellyjam", "Julius", "Jasmine",
        "Kawkaws", "Ki", "Kallus", "Keith", "Kevin", "Kitten", "Kedijah",
        "Larrius", "Lengeru", "Ludwiz", "Longboy", "Llij",
        "Moparscape", "Mardok", "Mueller", "Mastodon", "Morphius", "Murph", "McNasty", "Mehret",
        "Nilus", "Neo", "Nevarine", "Nix", "Nemo",
        "Ox", "Otherwilds", "Outerspace", "Oiler", "Officer", "Omexx",
        "Parrix", "Pickle", "Piledriver", "Puffpuff",
        "Quizler", "Qix", "Quark", "Qidus",
        "Roachest", "Rizz", "Rue",
        "Savi", "Serenity", "Silverhand", "Sammy", "Soothsayer", "Swissmiss", "Sully", "Semere", 
        "Tav", "Traveller", "Taximon", "Truegold", "Tuskies", "Tinkertot", 
        "Underway", "Uco",
        "Valiant", "Violence", "Vorton", "Voodoo", "Veuve", "Vexee",
